...
st.write("Uplaod your CSV and Excel Files to clean the dat convert format effortlessly🚀")
    ...
    for file in files:
        ...
        if st.button(f"⬇️ Download {file.name} as {format_choice}"):
            ...
            if format_choice == "CSV":
                ...
                output.seek(0)
                st.download_button("⬇️ Downlaod Files", file_name=new_name, data=output, mime=mime)
